...
# =============================================================================
    ...
    for idx, i in enumerate(list(images['new-human'].keys())):
        ...
        # dataset_home = 'C:/Users/jahna/OneDrive/Documents/GitHub/Project/classfication_human_vs_non_human/data/cropped/8x8/Human_Vs_Non_Human/'
        # subdirs = ['train/', 'test/']
...
if __name__ == '__main__':
    ...
    for i in cross_vals:
      ...
      # Generate a print
        ...
        scores = cnn_model.evaluate(inputs['train'], outputs['train'], verbose=0)
